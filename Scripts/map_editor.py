...
from utils import load_image, load_image_alpha, load_images
...
class Editor:
    ...
    def run(self):
        while True:
            ...
            self.scroll[1] += (self.movement[2] - self.movement[3]) * 3
            ...
            current_tile_img.set_alpha(190)

            self.display.blit(current_tile_img, (0, 0))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_o:
                        self.tilemap.save("data/maps/edited_map.json")
